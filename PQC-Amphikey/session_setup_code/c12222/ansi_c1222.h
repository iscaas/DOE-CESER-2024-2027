 ...
 * ansi_c1222.h
 *
 * Header file for the ANSI C12.22 protocol implementation.
 * This file defines the core structures, enumerations, and function
 * prototypes used for parsing and building C12.22 ACSE and EPSEM frames.
 *
 * This version has been updated to include 'extern' declarations for global
 * variables, allowing them to be shared with other source files like a server main.
 ********************************************************************************/
...
/**
 * @brief ANSI C12.22 ACSE Tag IDs
 */
typedef enum{
 ...
 *
 * These variables are defined in ansi_c1222.c. By declaring them here with
 * the 'extern' keyword, we make them accessible to other C files (like
 * main_server.c) that include this header. This is necessary for the server
 * to access the parsed request data.
 * ============================================================================= */
