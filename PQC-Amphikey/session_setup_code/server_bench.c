...
// Forward declaration for Raccoon's randombytes
...
// --- ORIGINAL HELPER FUNCTIONS (print_hex, write_binary_key_to_file, write_hex_key_to_file) ---
...
int main() {
    ...
    for (int i = 0; i < 48; i++) server_entropy_input[i] = (unsigned char)('S' + i);
